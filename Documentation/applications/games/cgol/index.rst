...
:ref:`framebuffer_character_driver`. If you have ``VIDEO_FB`` enabled,
you should be able to use the app. The visuals for the game are rendered
to a display through the provided frame buffer.
